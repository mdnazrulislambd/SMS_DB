...
VALUES ('Bangla'), ('English'), ('Math'), ('Science'), ('ICT');

-- Teachers
INSERT INTO Teachers (FullName, Gender, Qualification, Department, Phone)
VALUES ('Mr. Hasan', 'Male', 'B.Sc. in Physics', 'Science', '01700000001'),
       ('Ms. Rina', 'Female', 'M.A. in English', 'Arts', '01700000002');

-- ClassSubjects
INSERT INTO ClassSubjects VALUES (1,1), (1,2), (1,3), (1,4), (1,5);

-- TeacherSubjects
INSERT INTO TeacherSubjects VALUES (1,4), (2,2);
...
VALUES ('Mid Term', 'Half-yearly examination'),
...
VALUES (1, 1, 1, 'Class 6 Mid Term Exam 2025', '2025-05-10', '2025-05-20');

INSERT INTO ExamSubjects (ExamID, SubjectID, ExamDate, FullMarks, PassMarks)
VALUES (1, 1, '2025-05-10', 100, 33),
...
VALUES ('Headmaster'), ('Accountant'), ('Librarian'), ('Peon');

INSERT INTO Departments (DepartmentName)
VALUES ('Administration'), ('Library'), ('Accounts'), ('Transport');

INSERT INTO Transport (VehicleNo, DriverName, Capacity)
VALUES ('Dhaka-1234', 'Rahim', 40),
       ('Gazipur-5678', 'Karim', 35);

INSERT INTO Routes (RouteName, TransportID)
VALUES ('Dhaka City Route', 1),
       ('Gazipur Route', 2);
...
VALUES ('Boys Hostel', 'North Campus'),
...
INSERT INTO Roles (RoleName) VALUES ('Admin'), ('Teacher'), ('Parent');
